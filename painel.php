...
<head>
  <meta charset="UTF-8">
  <title>Transbet - Admin Panel</title>
...
<div id="wrapper">
  ...
  <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="painel.php">Transbet Admin Panel v1.0</a>
    </div>
    <!-- /.navbar-header -->
    ...
    <div class="navbar-default sidebar" role="navigation">
      <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
          ...
          <li>
            <a href="painel.php"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
          </li>
          <li>
            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Gestão de Ativos<span class="fa arrow"></span></a>
            <ul class="nav nav-second-level">
              <li>
                <a href="flot.html">Linhas Corporativas</a>
              </li>
              <li>
                <a href="morris.html">Desktop e Notebooks</a>
              </li>
              <li>
                <a href="morris.html">Impressoras</a>
              </li>
            </ul>
            <!-- /.nav-second-level -->
          </li>
          <li>
            <a href="tables.html"><i class="fa fa-edit fa-fw"></i> Termo de Responsabilidade</a>
          </li>
          <li>
            <a href="protocolo.php"><i class="fa fa-book fa-fw"></i> Livro de Protocolos</a>
          </li>
          <li>
          ...
          <li>
            <a href="#"><i class="fa fa-sitemap fa-fw"></i> Monitoramento da Rede<span class="fa arrow"></span></a>
            <ul class="nav nav-second-level">
              <li>
          ...
          <li>
            <a href="#"><i class="fa fa-files-o fa-fw"></i> Suporte<span class="fa arrow"></span></a>
            <ul class="nav nav-second-level">
              <li>
  ...
  <div id="page-wrapper">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">&nbsp;Bem vindo <?php echo $dados['login']; ?></h1>
      </div>
      <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
